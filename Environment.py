...
def DisplaySim(worldHistory, resourcesGRMaxE, displayVisualSim=True, mapFile=None):
    ...
    #Analyse.plotForCreatures(speedVis, 1, worldHistory[915][0], 233, 'Speed', 'Vis', 'Speed vs Vision in 914th step')
    ...
    Analyse.plotForSteps(biodiversity, 1, 111, len(worldHistory), "Biodiversity", 'bo-', 20, (worldHistory))
    #Analyse.plotForCreatures(speedReprThreshMouth, worldHistory[POI-5][0], 2, 231, 'Speed', 'Repr Thresh', 'Mouth Size', 'Genetics Plot in %dth step'%(POI-4))
    #Analyse.plotForCreatures(speedReprThreshMouth, worldHistory[POI][0], 2, 232, 'Speed', 'Repr Thresh', 'Mouth Size', 'Genetics Plot in %dth step'%(POI+1))
    #Analyse.plotForCreatures(speedReprThreshMouth, worldHistory[POI+5][0], 2, 233, 'Speed', 'Repr Thresh', 'Mouth Size', 'Genetics Plot in %dth step'%(POI+6))
    #Analyse.plotForCreatures(speedReprThreshMouth, worldHistory[POI+25][0], 2, 234, 'Speed', 'Repr Thresh', 'Mouth Size', 'Genetics Plot in %dth step'%(POI+26))
    #Analyse.plotForCreatures(speedReprThreshMouth, worldHistory[POI+50][0], 2, 235, 'Speed', 'Repr Thresh', 'Mouth Size', 'Genetics Plot in %dth step'%(POI+51))
    Analyse.plotForCreatures(speedReprThreshMouth, worldHistory[POI+599][0], 2, 111, 'Speed', 'Repr Thresh', 'Mouth Size', 'Genetics Plot in %dth step'%(POI+600))
    Analyse.plotForCreatures(speedReprThreshMouth, worldHistory[POI+599][0], 3, 111, 'Speed', 'Repr Thresh', 'Mouth Size', 'Genetics Plot in %dth step'%(POI+600), True)
